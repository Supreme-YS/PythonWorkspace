...
# 캐릭터(스프라이트) 이미지 불러오기
character = pygame.image.load("C:\\Users\\1234\\Desktop\\PythonWorkspace\\PythonWorkspace\\pygame_basic\\character.png")
character_size = character.get_rect().size # 이미지 크기 값 가져오기 
...
# 적 캐릭터
enemy = pygame.image.load("C:\\Users\\1234\\Desktop\\PythonWorkspace\\PythonWorkspace\\pygame_basic\\enemy.png")
enemy_size = enemy.get_rect().size # 이미지 크기 값 가져오기 
